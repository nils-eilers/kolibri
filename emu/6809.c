...
#ifdef H6309
static uint8_t MD;
static uint16_t V=0xFFFF;       /* init to all 1's at power-up */
...
static uint8_t clr(int CLK6809, int CLK6309)
{
    C = N = Z = OV = 0;
    CLK_ADD(CLK6809, CLK6309);
...
static uint16_t clr16(int CLK6809, int CLK6309)
{
    C = N = Z = OV = 0;
    CLK_ADD(CLK6809, CLK6309);
    ...
    do {
        ...
        switch (opcode) {
            ...
            case 0x1035:        /* ORR post */
                post_byte = imm_byte();
                set_reg((uint8_t)(post_byte & 0x0f), or16(get_reg((uint8_t)(post_byte >> 4)), get_reg((uint8_t)(post_byte & 0x0f)), 1, 1));
                break;
#endif
            ...
            case 0x1033:        /* SBCR post */
                post_byte = imm_byte();
                set_reg((uint8_t)(post_byte & 0x0f), sbc16(get_reg((uint8_t)(post_byte >> 4)), get_reg((uint8_t)(post_byte & 0x0f)), 1, 1));
                break;
#endif
            ...
            case 0x1032:        /* SUBR post */
                post_byte = imm_byte();
                set_reg((uint8_t)(post_byte & 0x0f), sub16(get_reg((uint8_t)(post_byte & 0x0f)), get_reg((uint8_t)(post_byte >> 4)), 1, 1));
                break;
